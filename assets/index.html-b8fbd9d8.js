...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,27);function p(b,g){const a=l("ExternalLinkIcon");return d(),o("div",null,[c(`
 * @Author: liguojing liguojing@tal.com
 * @Date: 2023-06-19 21:37:43
 * @LastEditors: liguojing liguojing@tal.com
 * @LastEditTime: 2023-06-19 21:44:25
 * @FilePath: /github/codingdocs/src/fe/node/index.md
 * @Description: 这是默认设置,请设置\`customMade\`, 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE
`),u,n("ul",null,[n("li",null,[s("下载安装包："),n("a",m,[s("https://nodejs.org/en/download/"),r(a)])]),v]),h])}const j=i(t,[["render",p],["__file","index.html.vue"]]);export{j as default};

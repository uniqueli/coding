import{_ as l}from"./plugin-vue_export-helper-c27b6911.js";import{r as t,o as r,c as a,b as e,d as n,e as s,f as o}from"./app-48000933.js";const d={},c=o(`<h1 id="node输出日志的正确姿势" tabindex="-1"><a class="header-anchor" href="#node输出日志的正确姿势" aria-hidden="true">#</a> Node输出日志的正确姿势</h1><h2 id="背景" tabindex="-1"><a class="header-anchor" href="#背景" aria-hidden="true">#</a> 背景</h2><p>每个程序员都喜欢在有问题的代码中插入一些日志的方法来帮助调试程序，比如System.out.println或console.log。解决后，就会将这些语句删除，周而复始。</p><p>但是通过系统日志输出的日志格式都是这种：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>// output
console.log(&quot;log&quot;); // log
